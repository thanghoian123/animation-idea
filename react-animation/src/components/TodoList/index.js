        ...
        <div className="flex w-full">
          <div className="relative w-full lg:max-w-sm flex-[1]">
            <select
              ...
              value={todo.name}
              className="w-full p-2.5 h-[42px] text-gray-500 bg-white border rounded-md shadow-sm outline-none appearance-none focus:border-indigo-600"
            >
              <option></option>
